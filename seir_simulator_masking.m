function [t, y, pVec] = seir_simulator_masking(eps, ppV, pImm,tspan,mask_u,mask_v)
...
%     pImm = 0.3; % percent of population with prior-infection immunity initially
    pVec = [N beta alpha gamma tau1 tau2 tau3 ppV*N (1 - ppV)*N eps mask_u, mask_v];
...
function f = seir2(t, y, pVec)
    ...
    f = zeros(9, 1);
    f(1) = -pVec(2)*y(1)*(1-pVec(11))*((1 - pVec(10))*(y(3)/pVec(9)) + pVec(10)*((y(8)/(1-pVec(11))*((1-0.5*pVec(11)-0.5*pVec(12))) + y(3))/pVec(1))) + (1/pVec(5))*y(4);
    f(2) = pVec(2)*y(1)*(1-pVec(11))*((1 - pVec(10))*(y(3)/pVec(9)) + pVec(10)*((y(8)/(1-pVec(11))*((1-0.5*pVec(11)-0.5*pVec(12))) + y(3))/pVec(1))) - (1/pVec(3))*y(2);
    f(3) = (1/pVec(3))*y(2) - pVec(4)*y(3);
    f(4) = pVec(4)*y(3) - (1/pVec(5))*y(4);
    f(5) = -(1/pVec(7))*y(5);
    f(6) = -pVec(2)*y(6)*(1-pVec(12))*((1 - pVec(10))*(y(8)/pVec(8)) + pVec(10)*((y(8) + y(3)/(1-pVec(12))*((1-0.5*pVec(11)-0.5*pVec(12))))/pVec(1))) + (1/pVec(7))*y(5) + (1/pVec(6))*y(9);
    f(7) = pVec(2)*y(6)*(1-pVec(12))*((1 - pVec(10))*(y(8)/pVec(8)) + pVec(10)*((y(8) + y(3)/(1-pVec(12))*((1-0.5*pVec(11)-0.5*pVec(12))))/pVec(1))) - (1/pVec(3))*y(7);
